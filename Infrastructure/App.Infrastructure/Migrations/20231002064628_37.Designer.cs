            ...
            modelBuilder.Entity("Designation", b =>
                {
                    ...
                    b.Property<string>("DesignationArabic")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DesignationEnglish")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Education", b =>
                {
                    ...
                    b.Property<string>("EducationEnglish")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HRPool", b =>
                {
                    ...
                    b.Property<bool?>("SendByWhatapp")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("SendByWhatappDateTime")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("SendToLocalDateTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SelectedCv", b =>
                {
                    ...
                    b.Property<DateTime?>("MusanedContractDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("MusanedContractNo")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SelectedCv", b =>
                {
                    ...
                    b.HasOne("HRPool", "HRPool")
                        .WithMany()
                        .HasForeignKey("HRPoolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
